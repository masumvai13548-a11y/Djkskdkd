...
# ==========================================
# UI TEXT & BUTTON CONFIGURATIONS (UNCHANGED)
# ==========================================
...
# ==========================================
# LOGIC & API INTEGRATION (FROM PROVIDED FILE)
# ==========================================
...
async def start_handler(event):
    ...
    gif_url = "https://media.giphy.com/media/59d1zo8SUSaUU/giphy.gif"
...
async def callback_handler(event):
    ...
    if data == "main_menu":
        ...
        await event.answer("Commands list coming soon!", alert=True)
