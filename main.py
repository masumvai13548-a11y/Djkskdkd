...
# --- FIXED: COMMANDS MENU (Updated text to list actual implemented commands) ---
COMMANDS_MENU_TEXT = (
    "⚙️ COMMANDS MENU\n\n"
...
# Exact same button layout from the screenshot
...
# --- FIXED: COMMANDS SUB-MENUS TEXTS ---
TOOLS_MENU_TEXT = (
    "🔧 TOOLS MENU\n\n"
    "Available Tools:\n\n"
...
# ==========================================
# FIXED: ADMIN SYSTEM (Unified helper function)
# ==========================================
...
# IMPORTANT: stop_handler must be defined before callback_handler 
# to ensure the STOP button is processed correctly.
...
async def callback_handler(event):
    ...
    # --- EXISTING GATES MENU ---
        ...
        await event.answer("Shopify Gates menu coming soon!", alert=True)
    elif data == "gate_charge":
        await event.answer("Charge Gates menu coming soon!", alert=True)
...
# ==========================================
# FIXED: ADMIN SYSTEM (Applied is_admin everywhere)
# ==========================================
